...
위의 문장에서 전달된 숫자 1과 4는 배열의 인덱스 정보이다. 
그러나 인덱스 1부터 4까지의 복사가 아니라 4이전까지의 복사를 의미한다는 점에 주의해야 한다. 

위의 예제와 달리 배열을 새로 생성하지 않고 존재하는 배열에 복사를 하려는 경우에는 java.lang.System 클래스의 다음 메소드를 호출하면 된다.
