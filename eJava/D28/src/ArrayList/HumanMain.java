...
// hashCode -> 맞는 저장소가서 equals method 호출

class HumanMain{
	public static void main(String[] args){
		HashSet<Human> hSet = new HashSet<Human>();
		hSet.add(new Human("이진호", 10));
		hSet.add(new Human("이진호", 20));
		hSet.add(new Human("김명호", 20));
		hSet.add(new Human("김명호", 15));
		hSet.add(new Human("이진호", 20));
		hSet.add(new Human("김명호", 20));
...
이렇듯 hash 메소드는 하나 이상의 인자를 조합하여 하나의 해쉬 값을 만들어 반환한다. 
따라서 특별한 경우가 아니라면 직접 해쉬 알고리즘을 만들지 않고 이 메소드에 의존해도 된다.
*/