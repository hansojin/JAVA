...
public interface PhoneUI extends PhoneMenuString {
	static final int MAX_CNT=100;
	public static Scanner sc = new Scanner(System.in);
	static PhoneBook pb = PhoneBook.getPhoneBookInst(MAX_CNT);
	...
	public static void inputMenuChoice() throws MenuChoiceException{
		...
		if (choice < GENERAL || choice > COMPANY)
	...
	public static void searchPhoneInfo(){
		...
		System.out.print("검색하시고자 하는 이름을 입력하세요. : ");
		name = sc.nextLine();
	...
	public static void deletePhoneInfo(){
		...
		if(result != -1){
			System.out.print("정말 삭제하시겠습니까? 1. Yes 2. No : ");
			answer = sc.nextInt();
			sc.nextLine();
			switch(answer){
			case YES:
