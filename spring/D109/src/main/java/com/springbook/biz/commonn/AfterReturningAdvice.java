...
//	public void getPointcut() {}
	...
	public void afterLog(JoinPoint jp, Object returnObj) {
		...
		System.out.println("[AfterReturningAdvice] " + method + "()'s 리턴값 : " + returnObj.toString());
	}
}
...
/*
	...
	이는 After Returning 어드바이스가 비즈니스 메소드 수행 결과를 받아내기 위해서 바인드 변수를 지정해야 하기 때문이다.
	XML 설정에서도 returning 속성을 사용하여 바인드 변수를 명확하게 지정할 수 있었다. 
	어노테이션 설정에서도 returning 속성을 이용하여 바인드 변수를 지정할 수 있다.
