...
/*
	...
	그리고 애스팩트를 설정할 때 pointcut-ref 속성으로 특정 포인트컷을 참조할 수 있었기 때문에 포인트컷을 재사용할 수 있었다.
	...
	BeforeAdvice, AfterReturningAdvice를 외부 Pointcut으로 수정한 후에 UserServiceClient의 main 메소드를 실행하여 실행결과를 본다.
*/